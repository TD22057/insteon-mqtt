...
class HubRFUnknown(Base):
    ...
    This 0x7f message is not documented anywhere and doesn't seem to do anything
    that can be detected. The message is likely generated by the Host on the
    Hub and we are only seeing the modem response.
