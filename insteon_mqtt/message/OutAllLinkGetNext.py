...
class OutAllLinkGetNext:
    ...
    The modem will respond with an echo/ACK of this message and an
    InpAllLinkRec message.
    """
    msg_code = 0x6a
    fixed_msg_size = 3
    ...
    def from_bytes(raw):
        ...
        """
        assert len(raw) >= OutAllLinkGetNext.fixed_msg_size
        assert raw[0] == 0x02 and raw[1] == OutAllLinkGetNext.msg_code
